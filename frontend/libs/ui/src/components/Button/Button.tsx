    ...
    case 'secondary':
      ...
      const to = theme.isLight
        ...
        : tinycolor(from)
            ...
            .toString();
      return {
        borderColor: theme.isLight ? theme.palette.gray85 : theme.palette.gray98,
        background: buttonVariantStyles(from, to, theme.isLight ? theme.palette.gray05 : theme.palette.gray4),
        // background: buttonVariantStyles(from, to, theme.isLight ? theme.palette.gray98 : theme.palette.gray4),
      };
