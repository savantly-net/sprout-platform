...
const preparePackage = async (pkg: any) => {
  pkg.bin = {
    'sprout-toolkit': './bin/sprout-toolkit.js',
  };
...
export const toolkitBuildTask = new Task<ToolkitBuildOptions>('@savantly/sprout-toolkit build', toolkitBuildTaskRunner);
