...
import { PanelProps, renderMarkdown, textUtil } from '@savantly/sprout-api';
// Utils
...
const ComponentWrapper = DangerouslySetHtmlContent as any;
  ...
  render() {
    ...
    return (
      <CustomScrollbar autoHeightMin="100%">
        <ComponentWrapper html={html} className={cx('markdown-html', styles.content)} />
      </CustomScrollbar>
    );
  }
}
