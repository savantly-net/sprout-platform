...
import { BackendSrvRequest, SproutBootConfig } from '@savantly/sprout-runtime';
...
export class FetchQueueWorker {
  constructor(fetchQueue: FetchQueue, responseQueue: ResponseQueue, config: SproutBootConfig) {
