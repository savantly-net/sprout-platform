import { __assign, __extends, __makeTemplateObject, __read, __spread, __values } from "tslib";
...
var CustomHeaderRow = function (_a) {
    ...
    return (React.createElement("div", { className: styles.layout },
        ...
        React.createElement(Button, { variant: "secondary", size: "xs", onClick: function (_e) { return onRemove(header.id); } },
...
var CustomHeadersSettings = /** @class */ (function (_super) {
    ...
    function CustomHeadersSettings(props) {
        ...
        _this.updateSettings = function () {
            ...
            var jsonData = _this.props.dataSourceConfig.jsonData;
            var secureJsonData = _this.props.dataSourceConfig.secureJsonData || {};
            try {
                for (var _b = __values(headers.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    Object.keys(jsonData)
                        .filter(function (key) {
                        return key.startsWith('httpHeaderName') && parseInt(key.substring('httpHeaderName'.length), 10) > headers.length;
                    })
            ...
            _this.props.onChange(__assign(__assign({}, _this.props.dataSourceConfig), { jsonData: jsonData,
                secureJsonData: secureJsonData }));
        };
        _this.onHeaderAdd = function () {
            _this.setState(function (prevState) {
                return { headers: __spread(prevState.headers, [{ id: uniqueId(), name: '', value: '', configured: false }]) };
    ...
    CustomHeadersSettings.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'gf-form-group' },
            ...
            React.createElement("div", { className: "gf-form" },
                React.createElement(Button, { variant: "secondary", icon: "plus", onClick: function (e) {
                        _this.onHeaderAdd();
                    } }, "Add header"))));
    };
