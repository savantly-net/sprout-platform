...
export var HttpProxySettings = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "gf-form-inline" },
            React.createElement(Switch, { label: "Forward OAuth Identity", labelClass: "width-13", checked: dataSourceConfig.jsonData.oauthPassThru || false, onChange: function (event) { return onChange(__assign(__assign({}, dataSourceConfig.jsonData), { oauthPassThru: event.currentTarget.checked })); }, tooltip: "Forward the user's upstream OAuth identity to the data source (Their access token gets passed along)." }))));
};
