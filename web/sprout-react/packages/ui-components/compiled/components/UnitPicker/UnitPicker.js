...
var UnitPicker = /** @class */ (function (_super) {
    ...
    UnitPicker.prototype.render = function () {
        ...
        return (React.createElement(Cascader, { width: width, initialValue: current && current.label, allowCustomValue: true, formatCreateLabel: formatCreateLabel, options: groupOptions, placeholder: "Choose", onSelect: this.props.onChange }));
    };
    return UnitPicker;
}(PureComponent));
export { UnitPicker };
