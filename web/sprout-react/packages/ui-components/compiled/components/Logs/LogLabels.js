...
var getStyles = stylesFactory(function (theme) {
    return {
        ...
        logsLabel: css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      label: logs-label;\n      display: flex;\n      padding: 0 2px;\n      background-color: ", ";\n      border-radius: ", ";\n      margin: 1px 4px 0 0;\n      text-overflow: ellipsis;\n      white-space: nowrap;\n      overflow: hidden;\n    "], ["\n      label: logs-label;\n      display: flex;\n      padding: 0 2px;\n      background-color: ", ";\n      border-radius: ", ";\n      margin: 1px 4px 0 0;\n      text-overflow: ellipsis;\n      white-space: nowrap;\n      overflow: hidden;\n    "])), selectThemeVariant({ light: theme.palette.gray5, dark: theme.palette.dark6 }, theme.type), theme.border.radius),
...
export var UnThemedLogLabels = function (_a) {
    ...
    return (React.createElement("span", { className: cx([styles.logsLabels]) }, displayLabels.map(function (label) {
