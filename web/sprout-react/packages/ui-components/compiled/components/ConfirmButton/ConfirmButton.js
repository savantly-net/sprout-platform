...
var getStyles = stylesFactory(function (theme) {
    return {
        ...
        confirmButtonContainer: css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      overflow: hidden;\n      position: absolute;\n      z-index: 1;\n    "], ["\n      overflow: hidden;\n      position: absolute;\n      z-index: 1;\n    "]))),
        confirmButton: css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      display: flex;\n      align-items: flex-start;\n    "], ["\n      display: flex;\n      align-items: flex-start;\n    "]))),
        confirmButtonShow: css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      opacity: 1;\n      transition: opacity 0.08s ease-out, transform 0.1s ease-out;\n      transform: translateX(0);\n    "], ["\n      opacity: 1;\n      transition: opacity 0.08s ease-out, transform 0.1s ease-out;\n      transform: translateX(0);\n    "]))),
        confirmButtonHide: css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      opacity: 0;\n      transition: opacity 0.12s ease-in, transform 0.14s ease-in;\n      transform: translateX(100px);\n    "], ["\n      opacity: 0;\n      transition: opacity 0.12s ease-in, transform 0.14s ease-in;\n      transform: translateX(100px);\n    "]))),
    };
});
    ...
    UnThemedConfirmButton.prototype.render = function () {
        ...
        return (React.createElement("span", { className: styles.buttonContainer },
            typeof children === 'string' ? (React.createElement("span", { className: buttonClass },
                React.createElement(Button, { size: size, variant: "link", onClick: onClick }, children))) : (React.createElement("span", { className: buttonClass, onClick: onClick }, children)),
            React.createElement("span", { className: styles.confirmButtonContainer },
                React.createElement("span", { className: confirmButtonClass },
                    React.createElement(Button, { size: size, variant: "link", onClick: this.onClickCancel }, "Cancel"),
