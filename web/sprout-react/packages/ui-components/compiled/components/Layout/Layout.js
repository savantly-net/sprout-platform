...
export var Layout = function (_a) {
    var children = _a.children, _b = _a.orientation, orientation = _b === void 0 ? Orientation.Horizontal : _b, _c = _a.spacing, spacing = _c === void 0 ? 'sm' : _c, _d = _a.justify, justify = _d === void 0 ? 'flex-start' : _d, _e = _a.align, align = _e === void 0 ? 'normal' : _e, _f = _a.wrap, wrap = _f === void 0 ? false : _f, _g = _a.width, width = _g === void 0 ? '100%' : _g, rest = __rest(_a, ["children", "orientation", "spacing", "justify", "align", "wrap", "width"]);
    var theme = useTheme();
    var styles = getStyles(theme, orientation, spacing, justify, align, wrap);
    return (React.createElement("div", __assign({ className: styles.layout, style: { width: width } }, rest), React.Children.toArray(children)
        .filter(Boolean)
...
export var HorizontalGroup = function (_a) {
    var children = _a.children, spacing = _a.spacing, justify = _a.justify, _b = _a.align, align = _b === void 0 ? 'center' : _b, wrap = _a.wrap, width = _a.width;
    return (React.createElement(Layout, { spacing: spacing, justify: justify, orientation: Orientation.Horizontal, align: align, width: width, wrap: wrap }, children));
};
export var VerticalGroup = function (_a) {
    var children = _a.children, spacing = _a.spacing, justify = _a.justify, align = _a.align, width = _a.width;
    return (React.createElement(Layout, { spacing: spacing, justify: justify, orientation: Orientation.Vertical, align: align, width: width }, children));
};
...
var getStyles = stylesFactory(function (theme, orientation, spacing, justify, align, wrap) {
    ...
    var marginCompensation = (orientation === Orientation.Horizontal && !wrap) || orientation === Orientation.Vertical
        ...
        : "-" + finalSpacing;
    return {
        layout: css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        label: HorizontalGroup;\n        display: flex;\n        flex-direction: ", ";\n        flex-wrap: ", ";\n        justify-content: ", ";\n        align-items: ", ";\n        height: 100%;\n        max-width: 100%;\n        // compensate for last row margin when wrapped, horizontal layout\n        margin-bottom: ", ";\n      "], ["\n        label: HorizontalGroup;\n        display: flex;\n        flex-direction: ", ";\n        flex-wrap: ", ";\n        justify-content: ", ";\n        align-items: ", ";\n        height: 100%;\n        max-width: 100%;\n        // compensate for last row margin when wrapped, horizontal layout\n        margin-bottom: ", ";\n      "])), orientation === Orientation.Vertical ? 'column' : 'row', wrap ? 'wrap' : 'nowrap', justify, align, marginCompensation),
