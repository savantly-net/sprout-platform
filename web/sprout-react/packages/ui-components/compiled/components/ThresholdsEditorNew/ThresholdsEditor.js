...
var ThresholdsEditor = /** @class */ (function (_super) {
    ...
    function ThresholdsEditor(props) {
        ...
        _this.onAddThreshold = function () {
            ...
            var newThresholds = __spread(steps, [add]);
        ...
        _this.onBlur = function () {
            var steps = __spread(_this.state.steps);
            sortThresholds(steps);
    ...
    ThresholdsEditor.prototype.renderInput = function (threshold, styles) {
        var _this = this;
        var isPercent = this.props.thresholds.mode === ThresholdsMode.Percentage;
        if (!isFinite(threshold.value)) {
            return (React.createElement(Input, { type: "text", value: 'Base', disabled: true, prefix: threshold.color && (React.createElement("div", { className: styles.colorPicker },
        ...
        return (React.createElement(Input, { type: "number", step: "0.0001", key: isPercent.toString(), onChange: function (event) { return _this.onChangeThresholdValue(event, threshold); }, value: threshold.value, onBlur: this.onBlur, prefix: React.createElement("div", { className: styles.inputPrefix },
                threshold.color && (React.createElement("div", { className: styles.colorPicker },
                    React.createElement(ColorPicker, { color: threshold.color, onChange: function (color) { return _this.onChangeThresholdColor(threshold, color); }, enableNamedColors: true }))),
    ...
    ThresholdsEditor.prototype.render = function () {
        ...
        return (React.createElement(ThemeContext.Consumer, null, function (theme) {
            ...
            return (React.createElement("div", { className: styles.wrapper },
                React.createElement(FullWidthButtonContainer, { className: styles.addButton },
                    React.createElement(Button, { size: "sm", icon: "plus", onClick: function () { return _this.onAddThreshold(); }, variant: "secondary" }, "Add threshold")),
                React.createElement("div", { className: styles.thresholds }, steps
                    .slice(0)
                    .reverse()
                    .map(function (threshold) {
                    return (React.createElement("div", { className: styles.item, key: "" + threshold.key }, _this.renderInput(threshold, styles)));
                })),
                React.createElement("div", null,
                    React.createElement(Label, { description: "Percentage means thresholds relative to min & max" }, "Thresholds mode"),
                    React.createElement(FullWidthButtonContainer, null,
                        React.createElement(RadioButtonGroup, { size: "sm", options: modes, onChange: _this.onModeChanged, value: thresholds.mode })))));
        }));
    };
