...
var Color = /** @class */ (function () {
    ...
    Color.prototype.css = function (inverted) {
        ...
        return rgb
            ? prop + 'rgba(' + __spread(rgb, [alpha]).join(',') + ');'
...
var stringWrappingMethods = (function () {
    return __spread(colorCodes.map(function (k, i) {
        return !k
            ? []
            : [
                // color methods
...
var assignStringWrappingAPI = function (target, wrapBefore) {
    ...
    return stringWrappingMethods.reduce(function (memo, _a) {
        var _b = __read(_a, 3), k = _b[0], open = _b[1], close = _b[2];
        ...
        switch (state) {
            ...
            case CODE:
                if (c >= '0' && c <= '9') {
                    ...
                    codes.push(new Code(code));
                    try {
                        for (var codes_1 = (e_1 = void 0, __values(codes)), codes_1_1 = codes_1.next(); !codes_1_1.done; codes_1_1 = codes_1.next()) {
...
var Colors = /** @class */ (function () {
    ...
    Object.defineProperty(Colors.prototype, "asChromeConsoleLogArguments", {
        ...
        get: function () {
            ...
            return __spread([spans.map(function (s) { return '%c' + s.text; }).join('')], spans.map(function (s) { return s.css; }));
        },
        enumerable: false,
        configurable: true
    });
