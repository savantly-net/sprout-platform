...
@Configuration
@Import(ExampleAppModuleConfiguration.class)
public class ExampleAppModule implements SproutWebModule {

	public static final String version = "0.0.1";
	protected static final String PLUGIN_ID = "example-app-module";
